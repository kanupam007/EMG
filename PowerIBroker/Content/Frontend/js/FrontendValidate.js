...
$(document).ready(function () {
                    ...
                    $.ajax({
                        ...
                        success: function (response) {
                            ...
                            if (response.responseText == "success")                              
                            {
                                ...
                                sweetAlert({
                                    title: "",
                                    text: "We have sent a password reset link on your email or phone",
                                    type: "success"
                                },
                                 function () {
                                     location.reload();
                                ...
                                sweetAlert({
                                    title: "",
                                    text: "Sorry, we don\'t have this email or phone in our system",
                                    type: "error"
                                });
                            else
                                sweetAlert({
                                    title: "",
                                    text: "Some error occurred while processing the request. Please try again",
                                    type: "error"
                                });
                        ...
                        error: function (response) {
                          ...
                          
                            {
                                sweetAlert({
                                    title: "",
                                    text: "We have sent a password reset link on your email",
                                    type: "success"
                                },
                                 function () {
                                     location.reload();
                                ...
                                sweetAlert({
                                    title: "",
                                    text: "Sorry, we don\'t have this email in our system",
                                    type: "error"
                                });
                            else
                                sweetAlert({
    ...
    $(".scroll").click(function (event) {
        ...
        $('html,body').animate({ scrollTop: $(this.hash).offset().top - 70 }, 1000).UItoTop({ easingType: 'easeOutQuart' });
    });

...
{
    [GASessionattribute]
    public class GeneralAgentController : Controller
    {
        ...
        [HttpPost]
        public ActionResult AddBrokerCompany(CompanyNew details)
        {
            long result = objClientMngmt.AddBrokerCompany(details);
        ...
        {
            return PartialView("~/Views/GeneralAgent/_BrokerList.cshtml");
        }
        ...
        public ActionResult ManageBroker(int ID=0)
        {
            ...
            var BrokerUserData = cmm.GetBrokerGAMaster(0, ID);
        ...
        public ActionResult ManageBroker(BrokerNew details)
        {
            ...
            if (details.BrokerId != 0)
            {
                ...
                objBroker = context.tblBrokers.Where(a => a.BrokerId == bId && a.IsActive==true).FirstOrDefault();
        ...
        {
            GeneralAgentUser obj = new GeneralAgentUser();
            if (details.SubBrokerId != 0)
            {
                obj = context.GeneralAgentUsers.Where(a => a.Id == details.SubBrokerId).FirstOrDefault();
            }
            obj.SubBrokerId = details.BrokerId;
            ...
            if (details.SubBrokerId == 0)
            {
                ...
                context.GeneralAgentUsers.Add(obj);
            }
            context.SaveChanges();
            return Json(obj.Id);
        }

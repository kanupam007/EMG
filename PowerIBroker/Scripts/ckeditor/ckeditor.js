...
(function() {
    if (!window.CKEDITOR || !window.CKEDITOR.dom) {
                        ...
                        if (c._length) {
                            for (var h in c)
                                if (h != "_length") {
                                    e = a.getAttribute(h) || "";
                                    if (h == "style") a: {
                                        g = c[h];typeof g == "string" && (g = CKEDITOR.tools.parseCssText(g));typeof e == "string" && (e = CKEDITOR.tools.parseCssText(e, true));d = void 0;
                                        for (d in g)
        ...
        CKEDITOR.config.font_names = "Arial/Arial,Open_Sansregular,Helvetica Neue, Helvetica, sans-serif;Comic Sans MS/Comic Sans MS, cursive;Courier New/Courier New, Courier, monospace;Georgia/Georgia, serif;Lucida Sans Unicode/Lucida Sans Unicode, Lucida Grande, sans-serif;Tahoma/Tahoma, Geneva, sans-serif;Times New Roman/Times New Roman, Times, serif;Trebuchet MS/Trebuchet MS, Helvetica, sans-serif;Verdana/Verdana, Geneva, sans-serif";
            ...
            function f(b) {
                if (b instanceof CKEDITOR.dom.selection) {
                    ...
                    a: {
                        ...
                        CKEDITOR.dom.element.clearAllMarkers(h);j = b[0].getParent();
        ...
        CKEDITOR.config.contentsCss = CKEDITOR.basePath + "contentsd.css";
